  ...
  return (
    ...
    <div>
      ...
      >
        ...
        {numberOfCartItems > 0 && <span className={`${classes.badge} text-[17px]` } >{numberOfCartItems}</span>}
        {numberOfCartItems > 0 ? <span className="text-[20px]">{totalAmount}</span> :""  }
      </button>
      ...
      {isBuyPageOpen && (
        ...
        >
          <div className="h-full bg-[#eee] dark:bg-gray-800 p-6  rounded-lg shadow-xl flex flex-col">
